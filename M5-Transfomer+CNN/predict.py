...
class Predictor():
    ...
    def create_model(self):
        self.model = TransformerCNNModel(config=self.config, vocab_size=self.vocab_size)
    ...
    def predict(self):
        ...
        for eval_batch in self.eval_data_obj.next_batch(self.eval_inputs, self.eval_labels,
            ...
            eval_summary, eval_loss, eval_predictions = self.model.eval(self.sess, eval_batch)
...
if __name__=="__main__":
    ...
    args = "transformerCNN_config.json"
